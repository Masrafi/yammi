...
class _OrderMobileState extends State<OrderMobile> {
  ...
  final userRef1 = Firestore.instance.collection('orderMobile');
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: ListView(children: <Widget>[
              ...
              Center(child: Text('মুবাইল নাম্বার')),
              TextFormField(
              ...
              Center(child: Text('বাড়ি নাম্বার')),
              TextFormField(
                //obscureText: true,
                textAlign: TextAlign.center,
                keyboardType: TextInputType.text,
